...
import { destinationCards, hero, journalEntries, parallaxSections } from "./lib/content";

export default function Home() {
  return (
    <>
      <NavBar />
      <Hero subtitle={hero.subtitle} title={hero.title} description={hero.description} image={hero.image} />
