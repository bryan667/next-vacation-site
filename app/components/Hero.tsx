...
export function Hero({ subtitle, title, description, image }: HeroProps) {
  return (
    <section className="relative flex h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[900px] backdrop-blur-[1.4px] px-5 py-5 text-center max-md:mx-4 max-md:px-5">
        <p className="mb-6 animate-[fadeUp_1s_0.2s_forwards] text-[0.8rem] font-bold uppercase tracking-[6px] text-[#ffcb79] opacity-0 [text-shadow:0_2px_18px_rgba(0,0,0,0.65)]">
          {subtitle}
        </p>
